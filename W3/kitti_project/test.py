...
def main(parser):
    ...
    cfg.OUTPUT_DIR = f"/home/group01/W3_detectron2/{parser.experiment_name}"
    ...
    testing = COCOEvaluator("ds_test", tasks=["bbox",], distributed=True, output_dir=os.path.join(cfg.OUTPUT_DIR, "eval_ds_test"))
