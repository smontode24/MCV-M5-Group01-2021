...
def main(parser):
    ...
    cfg.OUTPUT_DIR = f"/home/group01/W3_detectron2/pretrained"
    ...
    testing = COCOEvaluator("ds_test", tasks=["bbox",], distributed=True, output_dir=os.path.join(cfg.OUTPUT_DIR, "test_output"))
